...
public class BrobIntTester {
   ...
   public static void main( String[] args ) {
      ...
      try {
         System.out.println( "    Test 016: Adding g11 and g13 [10 + 234567] using bytes (but used ints): " );
      ...
      try {
         System.out.println( "    Test 018: Adding g13 and g11 [234567 + 10] using bytes (but used ints): " );
      ...
      try {
         System.out.println( "    Test 022: Adding g14 and g15 [-234567 + -10] using bytes (but used ints): " );
      ...
      try {
         System.out.println( "    Test 024: Adding g15 and g14 [-10 + -234567] using bytes (but used ints): " );
      ...
      try {
         System.out.println( "    Test 029: Adding g16 and g14 [-999999 + -234567] using bytes (but used ints): " );
      ...
      try {
         System.out.println( "\n      Test 031: Adding g1 and g4 using bytes (but used ints): " );
      ...
      System.out.println( "\n\n    TESTING SUBTRACTBYTE() METHOD:\n" +
                          "    ==============================" );
      System.out.println( "\n      Test 038: Subtracting g13 take away g11 [234567 - 10] using bytes (but used ints): " );
      try {
      ...
      System.out.println( "\n      Test 039: Subtracting g11 take away g13 [10 - 234567] using bytes (but used ints): " );
      try {
         System.out.println( "      expecting: -234557\n" +
      ...
      System.out.println( "\n      Test 040: Subtracting g13 take away g15 [234567 - (-10)] using bytes (but used ints): " );
      try {
      ...
      System.out.println( "\n      Test 041: Subtracting g15 take away g13 [(-10) - 234567] using bytes (but used ints): " );
      try {
         System.out.println( "      expecting: -234577\n" +
      ...
      System.out.println( "\n      Test 042: Subtracting g14 take away g16 [(-234567) - (-999999)] using bytes (but used ints): " );
      try {
      ...
      System.out.println( "\n      Test 043: Subtracting g16 take away g14 [(-999999) - (-234567)] using bytes (but used ints): " );
      try {
         System.out.println( "      expecting: -765432\n" +
      ...
      System.out.println( "\n      Test 044: Subtracting g1 take away g1 [too long to list] using bytes (but used ints): " );
      try {

...
public class DynamicChangemakerTestHarness {
   ...
   */
   public static void test_USA() {
      ...
      newDenominations  = new int[] { 51, 29, 11, 7, 5, 3, 2 };
      ...
      newDenominations  = new int[] { 121, 23, 17, 47, 3 };
      System.out.println( "\n    Test" + makeTwoDigits() + ": testing optimal solution for 13579 cents using " + Arrays.toString( newDenominations ) + ": " );
      result = DynamicChangeMaker.makeChangeWithDynamicProgramming( newDenominations, 13579 );
      try {
      ...
      newDenominations  = new int[] { 9, 7, 1 };
      ...
      try {
         System.out.print( "      expecting Tuple: <1,0,3>: " );
         displaySuccessIfTrue( "<1,0,3>".equals( result.toString() ) );
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      }
      ...
      try {
         System.out.print( "      expecting Tuple: <59038,2,0,0,1>: " );
         displaySuccessIfTrue( "<59038,2,0,0,1>".equals( result.toString() ) );
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      }

      newDenominations  = new int[] { 23, 17, 19, 13, 11  };
      System.out.println( "\n    Test" + makeTwoDigits() + ": testing for optimalsolution for 1357911 cents using " + Arrays.toString( newDenominations ) + ": " );
      System.out.println( "      This will take a second or two - please be patient......" );
      result = DynamicChangeMaker.makeChangeWithDynamicProgramming( newDenominations, 1357911 );
      try {
   ...
   public static void test_Euros() {
      ...
      try {
        System.out.print( "      expecting Tuple: <1,2,0,1,2,0>: " );
        displaySuccessIfTrue( "<1,2,0,1,2,0>".equals( result.toString() ) ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      }
   ...
   public static void test_SwissFrancs() {
      ...
      int[] francDenominations  = new int[] { 50, 20, 10, 5 };
      Tuple result = null;
      ...
      try {
        System.out.print( "      expecting Tuple: <2,0,0,1>: " );
        displaySuccessIfTrue( "<2,0,0,1>".equals( result.toString() ) ) ;
      } catch (Exception e) {
         e.printStackTrace();
         displayFailure();
      }
   ...
   */
   private static String makeTwoDigits() {
      testCount++;
      if( testCount < 10 ) {
         return String.valueOf( "0" + testCount );
      } else {
